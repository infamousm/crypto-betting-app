...
const navItems = [
  {
    icon: "/assets/imgs/home/card-1-flowers.png",
    iconActive: "/assets/imgs/home/card-1-flowers.png",
    label: "HOME",
    to: "/",
  },
  {
    icon: "/assets/imgs/landing/roulette.png",
    iconActive: "/assets/imgs/landing/roulette.png",
    label: "ROULETTE",
    to: "/roulette",
  },
  {
    icon: "/assets/imgs/landing/coinflip.png",
    iconActive: "/assets/imgs/landing/coinflip.png",
    label: "COINFLIP",
    to: "/coinflip",
  },
  {
    icon: "/assets/imgs/landing/rvs.png",
    iconActive: "/assets/imgs/landing/rvs.png",
    label: "RPS",
    to: "/rock-paper-scissor",
  },
  {
    icon: "/assets/imgs/landing/dice.png",
    iconActive: "/assets/imgs/landing/dice.png",
    label: "DICE",
    to: "/dice",
  },
  // {
        ...
        <div className="p-2 bg-dark-400 rounded-[28px] flex flex-col justify-between items-center gap-5">
          ...
          <div className="w-full flex flex-col justify-center items-center ">
            ...
            <a href="#0" className="w-12 h-12 flex justify-center items-center">
              <img src="/assets/imgs/common/telegram.png" alt="telegram" />
            </a>
            <a href="#0" className="w-12 h-12 flex justify-center items-center">
              <img src="/assets/imgs/common/twitter.png" alt="x" />
            </a>
